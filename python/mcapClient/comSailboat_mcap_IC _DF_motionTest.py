...
#f=open('record.txt', 'a')
#ser=serial.Serial("COM13", 115200)#For STAr_Server_Ceiling_individual
...
ser=serial.Serial("COM7", 115200)#For sailboat02
...
def read():
	while True:		
		...
		if line:
			...
			with open('comSailboat_mcap_IC _DF_motionTest.txt', 'a') as f:
