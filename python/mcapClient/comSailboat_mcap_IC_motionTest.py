...
ser=serial.Serial("COM7", 115200)#For sailboat02 Left port
...
def read():
	while True:		
		...
		if line:
			...
			with open('comSailboat_mcap_IC_motionTest.txt', 'a') as f:
				...
				f.write("\n")
			#with open('comSailboat_mcap_IC_motionTest.txt','a') as w:
